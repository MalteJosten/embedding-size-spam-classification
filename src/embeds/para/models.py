...
import embeds.para.pairing as pairing
import embeds.para.utils as utils
import os
from torch.nn.modules.distance import CosineSimilarity
from torch.nn.utils.rnn import pad_packed_sequence as unpack
from torch.nn.utils.rnn import pack_padded_sequence as pack
from embeds.para.evaluate_sts import evaluate_sts
from torch import optim

def load_model():
    model = torch.load(os.path.join("src", "embeds", "model.para.lc.100.pt"), weights_only=False)
    ...
    model_args.sp_model = os.path.join("src", "embeds", "paranmt.model")
